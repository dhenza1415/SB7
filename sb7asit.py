...
def help():
    ...
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Smule: [link\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Meme@n1@k1@k2\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Tafsirquran no|no\n"
    num = (num+1)    
                        ...
                        if cmd == "on":
                          ...
                          if wait["selfbot"] == True:
                    	    ...
                    	    if msg._from in owner or msg._from in admin or msg._from in staff: 
                              ...
                              cl.sendMessage(msg.to, contact.displayName, contentMetadata={'countryCode': 'ID', 'i-installUrl': 'line.me/ti/p/~dhenz415', 'a-packageName': 'com.spotify.music', 'linkUri': 'line.me/ti/p/~dhenz415', 'subText': contact.statusMessage, 'a-installUrl': 'line.me/ti/p/~dhenz415', 'type': 'mt', 'previewUrl': image, 'a-linkUri': 'line.me/ti/p/~dhenz415', 'Text': contact.displayName,'id': 'mt000000000a6b79f9', 'i-linkUri': 'line://ti/p/~dhenz415'}, contentType=19)
...
#====================================================================   
                                ...
                                try:
                                    ...
                                    for i in range(len(st)):
                                        ...
                                        cl.createComment(str(sender), str(result), wait["comment"])
                          ...
                          if msg._from in admin:    
                            try:
                                ...
                                with requests.session() as s:
                                    s.headers["userAgent"] = "Mozilla/5.0 (X11; U; Linux amd64; rv:5.0) Gecko/20100101 Firefox/5.0 (Debian)",
                                    ...
                                    try:
                                        ...
                                        cl.sendImageWithURL(msg.to, pict)
                                    except:
                                        cl.sendMessage(msg.to, "User tidak ditemukan!")                                        
